    ...
    o.anchorScroll = function (l, t) {
        ...
        n.$el = o(l), n.el = l, n.init = function () {
            ...
            if (t.preventDefault(), o(t.target).closest("a").length && o(n.el.hash).length) {
                ...
                "function" == typeof n.options.scrollStart && n.options.scrollStart.call(l), o(s).addClass(c).removeClass(a), o("html,body").animate({scrollTop: e + 1}, n.options.scrollSpeed).promise().done(function () {
