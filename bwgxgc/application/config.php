...
return [
    ...
    'mail'=>[
        ...
        'addr'            => '17635700990@163.com', // 发件邮箱地址
        'pass'            => 'bai1994817', // 发件邮箱密码
        'name'            => '杭州博卫', // 发件邮箱名称
        ...
        'log_path'        => '/path/to/tp-mailer/log', // 日志路径, 可选, 不配置日志驱动时启用默认日志驱动, 默认路径是 /path/to/tp-mailer/log, 要保证该目录有可写权限, 最好配置自己的日志路径
    ...
    'home_icon'             => '/home/iconfont',

    //给静态资源设置访问路径【home/shangpu分组】
    'home_shangpu_css'      => '/home/shangpu/css',
    'home_shangpu_img'      => '/home/shangpu/img',
    'home_shangpu_js'       => '/home/shangpu/js',
    'home_shangpu_video'    => '/home/shangpu/video',
    'home_shangpu_icon'     => '/home/shangpu/iconfont',
